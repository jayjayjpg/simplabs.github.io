...
category: "ruby on rails, custom engineering, consulting"
---
...
<div class="row content-section" id="wrapper">
  ...
  <div class="col-md-6 col-sm-12" id="text">
    <h4>trainline</h4>
...
<div class="row content-section trainline-section">
...
<div class="blue-banner">
  <div class="row content-section trainline-alternate">
    <div class="col-sm-8 col-sm-offset-2">
      <h1>&rdquo;</h1>
...
<div class="row content-section" id="wrapper">
  <div class="col-md-6 col-md-offset-1 col-sm-12" id="text">
    <h4>Solution</h4>
...
<div class="row content-section" id="wrapper">
  <div class="col-md-5 col-md-offset-1 col-sm-12" id="image">
  ...
  <div class="col-md-6 col-sm-12" id="text">
    ...
    <p>As of June 2017, we are still an active part of the engineering team behind both the desktop and mobile sites, leading optimization efforts as well as driving development efforts for additional features. </p>
  </div>
</div>